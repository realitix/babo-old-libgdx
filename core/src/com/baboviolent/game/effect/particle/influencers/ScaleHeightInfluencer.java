 ...
 *
 */
public class ScaleHeightInfluencer extends Influencer {
	
	public ScaledNumericValue value;
	private FloatChannel regionChannel, interpolationChannel, lifeChannel;
	
	public ScaleHeightInfluencer() {
		value = new ScaledNumericValue();
		value.setHigh(1);
	}
	
	public ScaleHeightInfluencer(ScaleHeightInfluencer influencer) {
		this();
		set(influencer);
	}
	
	private void set (ScaleHeightInfluencer influencer) {
	...
	public void update() {
		for(int i = 0, a = 0, l = ParticleChannels.LifePercentOffset,
			...
			regionChannel.data[i+ParticleChannels.HalfHeightOffset] = val/2; 
		}
	}
	...
	public ParticleControllerComponent copy () {
		return new ScaleHeightInfluencer(this);
	}
