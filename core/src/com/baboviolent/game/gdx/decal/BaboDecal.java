...
public class BaboDecal {
	//protected BaboDecalMaterial material = new BaboDecalMaterial();
	...
	public BaboDecalMaterial getMaterial () {
		return material;
	}
	...
	public static BaboDecal newDecal (TextureRegion textureRegion) {
		return newDecal(textureRegion.getRegionWidth(), textureRegion.getRegionHeight(), textureRegion, BaboDecalMaterial.NO_BLEND,
			BaboDecalMaterial.NO_BLEND);
	}
	 ...
	 * @return Created decal */
	public static BaboDecal newDecal (TextureRegion textureRegion, boolean hasTransparency) {
		return newDecal(textureRegion.getRegionWidth(), textureRegion.getRegionHeight(), textureRegion,
			hasTransparency ? GL20.GL_SRC_ALPHA : BaboDecalMaterial.NO_BLEND, hasTransparency ? GL20.GL_ONE_MINUS_SRC_ALPHA
				: BaboDecalMaterial.NO_BLEND);
	}
...
// from RGBA,..
	public static BaboDecal newDecal (float width, float height, TextureRegion textureRegion) {
		return newDecal(width, height, textureRegion, BaboDecalMaterial.NO_BLEND, BaboDecalMaterial.NO_BLEND);
	}
	 ...
	 * @param hasTransparency Whether or not this sprite will be treated as having transparency (transparent png, etc.)
	 * @return Created decal */
	public static BaboDecal newDecal (float width, float height, TextureRegion textureRegion, boolean hasTransparency) {
		return newDecal(width, height, textureRegion, hasTransparency ? GL20.GL_SRC_ALPHA : BaboDecalMaterial.NO_BLEND,
			hasTransparency ? GL20.GL_ONE_MINUS_SRC_ALPHA : BaboDecalMaterial.NO_BLEND);
	}
	 ...
	 * @return Created decal */
	public static BaboDecal newDecal (float width, float height, TextureRegion textureRegion, int srcBlendFactor, int dstBlendFactor) {
		BaboDecal decal = new BaboDecal();
