...
public class BaboSpriteBatch implements Batch {
	...
	public BaboSpriteBatch () {
		this(1000, null);
	}
	
	public BaboSpriteBatch (RenderContext context) {
		this(1000, null, context);
	}

	/** Constructs a SpriteBatch with one buffer and the default shader.
	 * @see SpriteBatch#SpriteBatch(int, ShaderProgram) */
	public BaboSpriteBatch (int size) {
		this(size, null);
	}
	
	public BaboSpriteBatch (int size, ShaderProgram defaultShader) {
		this(size, defaultShader, null);
	}
	...
	public BaboSpriteBatch (int size, ShaderProgram defaultShader, RenderContext context) {
	...
	public void flush () {
		...
		Texture t = lastTexture;
		tempDesc.set(t, t.getMinFilter(), t.getMagFilter(), t.getUWrap(), t.getVWrap());
		shader.setUniformi("u_texture", context.textureBinder.bind(tempDesc));
