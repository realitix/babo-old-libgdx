 ...
 * @author Nathan Sweet */
public class GrenadeWidget extends Widget {
	static private final Color tempColor = new Color();

	private GrenadeWidgetStyle style;
	...
	public GrenadeWidget (CharSequence text, Skin skin) {
		this(text, skin.get(GrenadeWidgetStyle.class));
	}

	public GrenadeWidget (CharSequence text, Skin skin, String styleName) {
		this(text, skin.get(styleName, GrenadeWidgetStyle.class));
	}

	public GrenadeWidget (CharSequence text, GrenadeWidgetStyle style) {
		if (text != null) this.text.append(text);
		setStyle(style);
		setSize(getPrefWidth(), getPrefHeight());
	}

	public void setStyle (GrenadeWidgetStyle style) {
	...
	/** Returns the label's style. Modifying the returned style may not have an effect until {@link #setStyle(GrenadeWidgetStyle)} is
	 * called. */
	public GrenadeWidgetStyle getStyle () {
		return style;
	}
	...
	/** The style for a label, see {@link GrenadeWidget}.
	 * @author Nathan Sweet */
	static public class GrenadeWidgetStyle {
		...
		public GrenadeWidgetStyle () {
		}

		public GrenadeWidgetStyle (BitmapFont font, Color fontColor, Drawable background) {
			this.font = font;
			this.fontColor = fontColor;
			this.background = background;
		}

		public GrenadeWidgetStyle (GrenadeWidgetStyle style) {
