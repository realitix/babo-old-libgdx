 ...
 * @author Nathan Sweet */
public class MolotovWidget extends Widget {
	static private final Color tempColor = new Color();

	private MolotovWidgetStyle style;
	...
	public MolotovWidget (CharSequence text, Skin skin) {
		this(text, skin.get(MolotovWidgetStyle.class));
	}

	public MolotovWidget (CharSequence text, Skin skin, String styleName) {
		this(text, skin.get(styleName, MolotovWidgetStyle.class));
	}

	public MolotovWidget (CharSequence text, MolotovWidgetStyle style) {
		if (text != null) this.text.append(text);
		setStyle(style);
		setSize(getPrefWidth(), getPrefHeight());
	}

	public void setStyle (MolotovWidgetStyle style) {
	...
	/** Returns the label's style. Modifying the returned style may not have an effect until {@link #setStyle(MolotovWidgetStyle)} is
	 * called. */
	public MolotovWidgetStyle getStyle () {
		return style;
	}
	...
	/** The style for a label, see {@link MolotovWidget}.
	 * @author Nathan Sweet */
	static public class MolotovWidgetStyle {
		...
		public MolotovWidgetStyle () {
		}

		public MolotovWidgetStyle (BitmapFont font, Color fontColor, Drawable background) {
			this.font = font;
			this.fontColor = fontColor;
			this.background = background;
		}

		public MolotovWidgetStyle (MolotovWidgetStyle style) {
